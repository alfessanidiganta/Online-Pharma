...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="{{asset('dashboard/assets/')}}" data-template="vertical-menu-template-free">
  ...
  <span class="app-brand-text demo menu-text fw-bolder ms-2">OnlinePharma</span>
</a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item ">
              <a href="{{route('editproduct')}}" class="menu-link">
            ...
            <li class="menu-item ">
              <a href="{{route('allpharmacy')}}" class="menu-link">
                <div data-i18n="Analytics">All Pharmacies</div>
              </a>
            </li>

            <li class="menu-item ">
              <a href="{{route('addpharmacy')}}" class="menu-link">
                <div data-i18n="Analytics">Add Pharmacy</div>
              </a>
            </li>

            <li class="menu-item ">
              <a href="{{route('editpharmacy')}}" class="menu-link">
                <div data-i18n="Analytics">Edit Pharmacy</div>
              </a>
            </li>
            ...
            <li class="menu-item ">
              <a href="{{route('pendingorder')}}" class="menu-link">
                <div data-i18n="Analytics">Pending</div>
              </a>
            </li>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            ...
                            <small class="text-muted">{{$users->role_user}}</small>
                          </div>
                        </div>
                      </a>
                    </li>
                    ...
                    <li>
                      <a class="dropdown-item" href="#">
                        ...
                        <span class="align-middle">{{$users->name}}</span>
                      </a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="#">
