...
<body>
    ...
    <header class="header_area">
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between">
            ...
            <nav class="classy-navbar" id="essenceNav">
                <!-- Logo -->
                <a href="#"><h2><b>Online Pharma</b></h2></a>
                <!-- Navbar Toggler -->
                ...
                <div class="classy-menu">
                    ...
                    <div class="classynav">
                        <ul>
                            <li><a href="#">OTC Medicines</a>
                                <div class="megamenu">
   
                                
                                </div>
                            </li>
                            <li><a href="#">Prescribed Medicines</a>
                               
                            </li>
                            <li><a href="blog.html">Healthcare Products</a></li>
                        </ul>
                    </div>
                    <!-- Nav End -->
                </div>
    ...
    <div class="right-side-cart-area">
        ...
        <div class="cart-button">
            <a href="#" id="rightSideCart"><img src="{{asset('home/img/core-img/bag.svg')}}img/core-img/bag.svg" alt=""> <span>3</span></a>
        </div>
            ...
            <div class="cart-list">
                ...
                <div class="single-cart-item">
                    <a href="#" class="product-image">
                        <img src="{{asset('home/img/product-img/product-1.jpg')}}.jpg" class="cart-thumb" alt="">
                        <!-- Cart Item Desc -->
